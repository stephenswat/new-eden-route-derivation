...
public:
    ...
    double jump_range = NAN, warp_speed, align_time = 0.0, gate_cost;
    enum fatigue_model fatigue_model = FATIGUE_REACTIVATION_COUNTDOWN;
};

static const Parameters FRIGATE = Parameters(5.0, 3.0, 10.0, NAN);
static const Parameters DESTROYER = Parameters(4.5, 4.0, 10.0, NAN);
static const Parameters CRUISER = Parameters(3.0, 7.0, 10.0, NAN);
static const Parameters BATTLECRUISER = Parameters(2.7, 8.0, 10.0, NAN);
static const Parameters BATTLESHIP = Parameters(2.0, 12.0, 10.0, NAN);

static const Parameters BLACK_OPS = Parameters(2.2, 10.0, 10.0, 8.0);
...
static const Parameters RORQUAL = Parameters(1.5, 50.0, -1.0, 10.0);
static const Parameters JUMP_FREIGHTER = Parameters(1.5, 40.0, -1.0, 10.0);
